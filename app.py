...
# Verificar se já existe uma tabela na sessão do Streamlit
if 'history' not in st.session_state:
    st.session_state.history = pd.DataFrame(columns=['Open', 'High', 'Low', 'Predicao'])
...
if submit_button:
    ...
    # Adicionar os dados inseridos pelo usuário com a previsão à tabela existente
